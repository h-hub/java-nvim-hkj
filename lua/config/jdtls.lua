local function get_jdtls()
	...
	local jdtls_path = vim.fn.expand("$MASON/packages/") .. jdtls.name
...
local function get_bundles()
	...
	local java_debug_path = vim.fn.expand("$MASON/packages/") .. java_debug.name
	...
	local java_test_path = vim.fn.expand("$MASON/packages/") .. java_test.name
